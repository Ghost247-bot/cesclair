...
export default function HolidayOutfittingPage() {
  const allProducts = [
    ...getProductsByCategory('outerwear', 'women'),
    ...getProductsByCategory('sweaters', 'women'),
    ...getProductsByCategory('pants', 'women'),
    ...getProductsByCategory('outerwear', 'men'),
    ...
    <>
      ...
      <main className="min-h-screen bg-background pt-[60px] md:pt-[64px]">
        <div className="container mx-auto px-6 md:px-8 py-12 md:py-16">
          <div className="mb-8">
            <h1 className="text-4xl md:text-5xl font-medium mb-4">Holiday Outfitting</h1>
            <p className="text-body-large text-secondary-text">Complete looks for the season's celebrations.</p>
          </div>
