...
export default function WomenSalePage() {
  const allProducts = getProductsByCategory('sale', 'women');
    ...
    <>
      ...
      <main className="min-h-screen bg-background pt-[60px] md:pt-[64px]">
        <div className="container mx-auto px-6 md:px-8 py-12 md:py-16">
          <div className="mb-12">
            <h1 className="text-4xl md:text-5xl font-medium mb-4">Women's Sale</h1>
            <p className="text-body-large text-secondary-text">Premium pieces at reduced prices</p>
          </div>
